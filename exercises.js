...
function exercise_06() {
  ...
  */
  ...
  let message = "Let's go Seattle Torrent!";
  ...
  console.log("The length of the message is", length, "characters");
...
function exercise_10() {
  ...
  */
  ...
  console.log("Author (bracket notation):", book["author"]);
...
function exercise_11() {
  ...
  */
  ...
  book["genre"] = "Fiction, Dystopian, Young Adult";
...
function exercise_14() {
  ...
  */
  ...
  console.log("Datetime String:", currentDate);
...
function exercise_16() {
  ...
  */
  ...
  const birthday = new Date(1996, 6, 5);
  let dateString = birthday.toDateString();
  console.log("My birthday is", dateString);
...
function exercise_17() {
  ...
  */
  ...
  const operation = timeDifference / (1000 * 60 * 60 * 24);
  const roundedDate = Math.ceil(operation);
  console.log("Difference in days:", roundedDate);
...
function exercise_19() {
  ...
  /* 
    ...
    3. Finally, check to see if the 'text' variable contains the specific string 'javascript'. 
       ...
       Explation: The method for includes() is case senstive which means that uppercase and lowercase values are considered different even if they are the same letter.
